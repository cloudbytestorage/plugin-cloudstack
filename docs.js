...
cloudStack.docs = {
    ...
    //CloudByte storage related docs
    helpTSMServer: {
        desc: 'IP Address of TSM i.e. virtual storage controller',
        externalLink: ''
    },
    helpTSMSubnet: {
        desc: 'Subnet mask valid for the TSM. Should be provided as pure numbers starting from 1 till 24.',
        externalLink: ''
    },
    helpTSMInterface: {
        desc: 'Select the active NIC.',
        externalLink: ''
    },
    helpTSMCapacity: {
        desc: 'Capacity of primary storage',
        externalLink: ''
    },
    helpTSMIOPS: {
        desc: 'IOPS of primary storage',
        externalLink: ''
    }    
};
