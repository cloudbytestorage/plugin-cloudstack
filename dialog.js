    ...
    cloudStack.dialog = {
        ...
        createForm: function(args) {
            ...
            $(fields).each(function(idx, element) {
                ...
                if (field.select) {
                ...
                } else if (field.slider) { // A slider element
                    $slider = $('<div class="slider">')                        
                        .css('width', '109px')
                        .css('padding', '10px 0px 0px 0px')
                        .css('margin', '8px 3px 3px')
                        .css('background', 'url(images/bg-gradients.png) 0px -307px')
                        .css('float', 'left')
                        .css('text-align', 'center')
                        .css('display', 'inline-block');
                    $sliderAnchor = $('<a class="ui-slider-handle ui-state-default ui-corner-all" href="#">')
                        .css('display', 'block')
                        .css('background', 'url(images/buttons.png) -622px -274px')
                        .css('width', '18px')
                        .css('height', '18px')
                        ...
                        .appendTo($slider);
                    $sliderMaxValue = $('<label class="max">')
                        .css('width', 'auto')
                        .css('color', '#647A8E')
                        .css('font-weight', 'bold')
                        .css('-moz-text-shadow', '0px 1px 1px #FFFFFF')
                        .css('-webkit-text-shadow', '0px 1px 1px #FFFFFF')
                        .css('-o-text-shadow', '0px 1px 1px #FFFFFF')
                        .css('text-shadow', '0px 1px 1px #FFFFFF')
                        .css('display', 'block')
                        .css('float', 'left')
                        .css('margin', '10px 17px 0px 15px')
                        .css('font-size', '14px')
                        .addClass(key)
                        .html('<span></span>');
                    $input = $('<input type="text" class="disallowSpecialCharacters">')
                        .attr({
                            name : key                 
                        })
                        .val(1)
                    ...
                    // Append all the above DOM to $value
                    $slider.appendTo($value);
                    $sliderMaxValue.appendTo($value);
